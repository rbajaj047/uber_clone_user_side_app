              ...
              child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text("Pay Cash", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                      Text("Rs. ${widget.fareAmount!}", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                    ],
                  ),
              ),
            ),
